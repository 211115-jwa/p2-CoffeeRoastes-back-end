package p2CoffeeRoastesvanquishbackend.servicestesting;
...
public class UserServiceTest {
	...
	/*
	 * @Test public void registerPersonSomethingWrong() throws
	 * UsernameAlreadyExistsException { User person = new User();
	 * when(personRepo.save(person)).thenThrow(new RuntimeException()); User
	 * actualPerson = userServ.register(person); assertNull(actualPerson); }
	 */
	
	/*
	 * @Test public void registerPersonUsernameAlreadyExists() { User person = new
	 * User(); when(personRepo.save(person)).thenThrow(new
	 * RuntimeException("unique constraint violation"));
	 * 
	...
	/*
	 * @Test public void findActivePlansPOSITIVE() { User user = new User();
	 * user.setId(99999); when(customerplanRepo.findByActiveAndUser("True",
	 * user)).thenReturn(mockcurrentplans); Set<CustomerPlan> activePlans =
	 * customerplanRepo.findByActiveAndUser("True", user); boolean onlyactive =
	 * true; for (CustomerPlan customerplan : activePlans) { if
	 * (!customerplan.getActive().equals("True")) onlyactive = false; }
	 * 
	 * assertTrue(onlyactive); }
	 * 
	 * @Test public void findActivePlansNEGATIVE() { User user = new User();
	 * user.setId(99999); when(customerplanRepo.findByActiveAndUser("asdasd",
	 * user)).thenReturn(mockcurrentplans); Set<CustomerPlan> activePlans =
	 * customerplanRepo.findByActiveAndUser("asdasd", user); boolean onlyactive =
	 * true; for (CustomerPlan customerplan : activePlans) { if
	 * (!customerplan.getActive().equals("asdasd")) onlyactive = false; }
	 * 
	 * assertTrue(onlyactive); }
	 */
	...
	/*
	 * @Test public void GetPlanPositive() throws customerplandoesnotexist {
	 * CustomerPlan newplan = new CustomerPlan();
	 * newplan.setCustomer_plan_id(77777); mockcurrentplans.add(newplan);
	 * 
	 * assertEquals(newplan, userServ.getcustomerPlanbyID(77777)); }
	 */
	
	/*
	 * @Test public void GetPlanNegative() throws customerplandoesnotexist {
	 * CustomerPlan newplan = new CustomerPlan();
	 * newplan.setCustomer_plan_id(77777); mockcurrentplans.add(newplan);
	 * 
	...
	/*
	 * @Test public void TogglePositive() throws customerplandoesnotexist {
	 * CustomerPlan newplan = new CustomerPlan();
	 * newplan.setCustomer_plan_id(77777); newplan.setActive("True");
	 * mockcurrentplans.add(newplan); userServ.toggle(77777); assertEquals("False",
	 * userServ.getcustomerPlanbyID(7777)); }
	 */
	
	/*
	 * @Test public void ToggleNegative() throws customerplandoesnotexist {
	 * CustomerPlan newplan = new CustomerPlan();
	 * newplan.setCustomer_plan_id(77777); newplan.setActive("True");
	...
	/*
	 * @Test public void updateUserPositive() throws CustomerDoesNotExistException {
	 * User newuser = new User(); newuser.setUsername("Kahewm");
	 * newuser.setId(123587); mockcurrenUsers.add(newuser);
	 * 
	 * newuser.setUsername("Katthewm"); userServ.updateUser(newuser);
	 * assertEquals("Katthewm", userServ.getUserById(123587).getUsername()); }
	 */
	
	/*
	 * @Test public void updateUserNegative() throws CustomerDoesNotExistException {
	 * User newuser = new User(); newuser.setUsername("Kahewm");
	 * newuser.setId(123587); mockcurrenUsers.add(newuser);
	 * 
	 * newuser.setUsername("Katthewm"); userServ.updateUser(newuser);
